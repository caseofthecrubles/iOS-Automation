//March 11 2024
//This requires the companion python webserver or any webserver that can log the inbound headers from a git request "webserver_for_iphones.py"
import Foundation
import XCTest
...
final class test_appUITests44LaunchTests: XCTestCase {
    ...
    func walkapp_curl(of app: XCUIApplication) -> String? { // Return type is String?
        // Iterate through all elements and curl the result to the specified server
    ...
    func testToggleWiFi() throws {//main code here
